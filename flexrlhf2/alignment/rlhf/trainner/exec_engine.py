...
from alignment.rlhf.config import ModelConfig, TrainConfig, EvalConfig, RuntimeConfig, \
    Placement, AllCollocate, ProfilerConfig, InitialRewardSeparate, ModelRanks
...
class ExecutionEngine:
    def __init__(self, 
        ...
        path, fname= config_path.rsplit('/', 1)
        with initialize(version_base=None, config_path='../../'):
            self.config = compose(config_name=fname.rsplit('.', 1)[0])
        ...
        if isinstance(model_provider, ACNoneShareSEPModelProvider):
            ...
            # TODO: 接入ActorDistributedSEPModuleEngine
            ...
            rl_trainer = ACNoneShareDeepSpeedModule
